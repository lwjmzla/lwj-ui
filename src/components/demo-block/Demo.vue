  ...
  >
    ...
    >
      ...
      <div class="control-button-wrap">
        ...
        <transition name="text-slide">
          <span class="control-button copy-button" @click.stop="runcode">
            运行代码
          </span>
        </transition>
      </div>
...
export default {
  ...
  setup(props: { sourceCode: any }) {
    ...
    const runcode = () => {
      const codeSource = props.sourceCode;
      local.set("preview-source", codeSource);
      window.open("/vue3/runcode.html", "_blank","noopener,noreferrer");
    }
